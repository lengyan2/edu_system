...
public class test {
    //账号AK信息请填写（必选）
    private static final String accessKeyId = "LTAI5t6oV8zBYuRfccajo2Nj";
    //账号AK信息请填写（必选）
    private static final String accessKeySecret = "Aq1ZKNMkGW9Ul9C5kLRxpBEA2e3xIH";
    ...
    public static void main(String[] args) {
        ...
        // 任何上传方式文件名必须包含扩展名
        String fileName = "/Users/daiyuanjing/Desktop/演示视频.mp4";
        // 本地文件上传
        testUploadVideo(accessKeyId, accessKeySecret, title, fileName);

        // 待上传视频的网络流地址
//        String url = "https://edu-10-test.oss-cn-guangzhou.aliyuncs.com/";
